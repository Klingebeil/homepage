...
Tech-Influencers are generally distinct from Rogers’ (1962) “Diffusion of Innovation” theories *opinion leaders*, which a) argue from direct and embedded experience, b) try to reduce uncertainty / stabilise meanings, and c) are part of a given community.

Of course, as Rogers published way before social media and the excesses of Entrepreneurialism, influencers never played a role in his research.

Influencers, in contrast to Rogers, a) often have only surface-level experience with a technology and are often limited to gadgets or marketing releases, b) inject and leverage uncertainty to attract attention, and c) are often external commentators. (Notably, this might not be the case for e.g. influencers from niche developer circles.)

Influencers are often embedded in an information network of other commentators, laundering generally hype-y messaging with little to no critical distance.

Influencers are more focused on creating a spectacle and brand building by over-inflating and sensationalising their messaging.
