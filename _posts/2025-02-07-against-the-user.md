...
subtitle: "Concepts used mindlessly tend to bite back"
date: 2025-02-07
...
There is another risk. As [Johann Redström notes](https://doi.org/10.1016/j.destud.2005.06.001), “there is a fundamental difference between designing things to be used and trying to design use or the user experience.” When artifacts are designed too narrowly—optimized for a single, predefined use—the result is often a more rigid and less adaptable design. In contrast, when artifacts allow for multiple forms of engagement and interpretation, they become more dynamic, flexible, and are easily adopted into diverse contexts. The *user*, in effect, can actually harm the design process.

This is especially apparent in the current discourse around the possible impacts of *artifical intelligence* in journalism. If we consider the question only through the lens of the *user*, we will never get any further than the tired cliché of [the personalized news assistant](https://johannesklingebiel.de/2022/11/18/forget-siri.html). One in which the relationship with journalism is further flattened and eroded, as the *user* is forced into a singular news experience.
